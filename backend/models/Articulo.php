...
class Articulo {
    ...
    // Constructor
    public function __construct($codigoBarras, $tiendaId, $disenoId, $codigoProducto, $nombreCorto, $nombreArticulo, $precioInicial, $precioVenta,$etiqueta,  $infoExtra) {
    ...
    public function aniadirArticulo(){
        try {
            if(!$this->articuloExiste()){
                ...
                $sql = "INSERT INTO Articulos (codigo_barras, store_id, id_plantilla, codigo_producto, nombre_corto, nombre_articulo, precio_inicial, precio_venta, etiqueta, info_extra) 
                        VALUES (:codigo_barras, :tienda_id, :diseno_id, :codigo_producto, :nombre_corto, :nombre_articulo, :precio_inicial, :precio_venta,:etiqueta,  :info_extra)";
        ...
        try {
            if($this->articuloExiste()) {
                ...
                $sql = "UPDATE Articulos SET store_id = :tienda_id, id_plantilla = :diseno_id, codigo_producto = :codigo_producto,
                        ...
                        precio_venta = :precio_venta, etiqueta = :etiqueta ,info_extra = :info_extra WHERE codigo_barras = :codigo_barras";
    ...
    public function getArrayArticulo(){
        $arrayArticulo = array(
            ...
            "originalPrice" => $this->precioInicial,
