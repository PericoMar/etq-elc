                ...
                <?php foreach ($productosPagina as $producto) : ?>
                    <tr>
                        ...
                        <td class="acciones">
                            ...
                            <button class="btn-eliminar product-opt" data-codigo-barras="<?php echo $producto['codigo_barras']; ?>" data-nombre-articulo="<?php echo $producto['nombre_articulo']; ?>" data-etiqueta="<?php echo $producto['etiqueta'] ?>">
